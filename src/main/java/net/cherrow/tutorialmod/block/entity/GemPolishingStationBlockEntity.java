package net.cherrow.tutorialmod.block.entity;

import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.cherrow.tutorialmod.item.ModItems;
import net.cherrow.tutorialmod.recipe.GemPolishingRecipe;
import net.cherrow.tutorialmod.screen.GemPolishingScreenHandler;
